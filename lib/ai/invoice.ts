    ...
    messages: [
      {
        role: "system",
        content:
          "Analiza la imagen de una factura o remito y devuelve solo un JSON valido. Incluye supplier_name, invoice_number, invoice_date, currency, notes e items. Cada item debe tener name, description, quantity, unit y unit_price. Si un dato no se puede leer con certeza, usa null o una cadena vacia segun corresponda, pero no inventes valores.",
      },
      {
        role: "user",
        content: [
